...
class HttpAdminServer(
    ...
    override fun observeState(): Flow<AdminState> = state
            ...
            routing {
                get("/admin") {
                    ...
                    if (secretParam == params.secret) {
                        call.request.queryParameters["url"]?.let { displayRepo.loadDisplayFromUrl(it) }
                ...
                post("/admin/display") {
                    ...
                    call.receiveMultipart().forEachPart { part ->
                        if (part is PartData.FileItem) {
                            displayRepo.loadDisplayFromJsonString(part.streamProvider().readBytes().decodeToString())
                        }
                        part.dispose
                    }
                }
